...
<div class="mpDynamicContent">
    ...
    {if $isBackendEditMode == true}
        ...
        <script type="text/javascript" src="{$backendHtmlPath}scripts/jquery/jquery-ui.js"></script>
        {/if}
        <link rel="stylesheet" type="text/css" href="{$backendHtmlPath}styles/jquery/jquery-ui.css">
        {literal}
        <style type="text/css">
